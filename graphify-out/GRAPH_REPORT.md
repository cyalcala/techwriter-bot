...
Cohesion: 0.09
Nodes (39): escapeAttr(), escapeHtml(), formatArtifactRendererError(), getArtifactRecoveryHint(), getArtifactTypeLabel(), detectLanguage(), domReady(), escapeAttr() (+31 more)
...
Cohesion: 0.14
Nodes (18): archiveConversation(), cleanTitle(), createConversationSnapshot(), deleteConversation(), listVisibleConversations(), renameConversation(), sortByUpdatedDesc(), titleFromFirstUserMessage() (+10 more)
...
- **Why does `setTimeout()` connect `Community 7` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 11`, `Community 14`?**
