...
Cohesion: 0.05
Nodes (40): ../lib/artifact-lifecycle, ../lib/artifact-queue, ../lib/artifact-state, ../lib/artifact-types, ../lib/cleanup, ../lib/markdown, ../lib/rag-client, ../lib/renderer-loader (+32 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (36): ../lib/artifact-detector, regenerateArtifactEntry(), detectAllArtifacts(), detectLang(), langToType(), normalizeType(), RawArtifact, validateArtifact() (+28 more)
...
- **Why does `createRequestId()` connect `Community 0` to `Community 11`, `Community 3`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `apiError()` connect `Community 0` to `Community 11`, `Community 3`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `kvKey()` connect `Community 0` to `Community 3`, `Community 7`?**
