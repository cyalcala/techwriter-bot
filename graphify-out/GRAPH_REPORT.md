...
Cohesion: 0.07
Nodes (54): ALLOWED_ORIGINS, bindSession(), checkCSRF(), checkRateLimit(), dailyUsage, DC_ASNS, GET(), getReputation() (+46 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (43): GET(), ALLOWED_ORIGINS, checkCSRF(), dailyEmbedCounts, now, POST(), RateLimitEntry, rateLimits (+35 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (40): ../lib/rag-client, ../lib/rag-db, clearAllData(), clearLegacyBrowserState(), runStaleCheck(), chunkText(), embedChunks(), embedLocal() (+32 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (35): getInjectedProviderStatus(), parseProviderFaultInjection(), parseProviderFaultSpec(), readEnvString(), safeEquals(), asCount(), emptyBucket(), recordProviderTelemetry() (+27 more)
...
Cohesion: 0.07
Nodes (25): ../lib/artifact-types, a, blob, url, fail(), renderTimeout, artifactEntryKey(), chipBases (+17 more)
...
Cohesion: 0.18
Nodes (11): ../lib/stream-parser, regenerateArtifactEntry(), ArtifactStatus, ArtifactEntry, ArtifactQueue, createArtifactQueue(), Subscriber, createArtifactRegenerationPrompt() (+3 more)
...
- **Why does `setTimeout()` connect `Community 8` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 11`?**
