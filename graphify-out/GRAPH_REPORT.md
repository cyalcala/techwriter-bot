...
Cohesion: 0.05
Nodes (42): ../lib/artifact-detector, ../lib/artifact-lifecycle, ../lib/artifact-queue, ../lib/artifact-state, ../lib/cleanup, ../lib/markdown, ../lib/renderer-loader, ../lib/session-persist (+34 more)
...
Cohesion: 0.07
Nodes (19): fixArtifactError(), getActiveArtifact(), SplitArtifact, SplitTab, ARTIFACT_LANGUAGE_ALIASES, balanced(), CODE_LANGS, looksLikeVegaSpec() (+11 more)
...
Cohesion: 0.1
Nodes (23): chatMarkdownExportFilename(), cleanInline(), codeFence(), createChatMarkdownExport(), escapeLinkText(), archiveConversation(), cleanTitle(), createConversationSnapshot() (+15 more)
...
- **Why does `setTimeout()` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 8`, `Community 10`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `createRequestId()` connect `Community 1` to `Community 0`, `Community 13`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `apiError()` connect `Community 1` to `Community 0`, `Community 13`?**
