...
Cohesion: 0.05
Nodes (58): GET(), ALLOWED_ORIGINS, checkCSRF(), dailyEmbedCounts, now, POST(), RateLimitEntry, rateLimits (+50 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (62): ALLOWED_ORIGINS, bindSession(), checkCSRF(), checkRateLimit(), dailyUsage, DC_ASNS, GET(), getReputation() (+54 more)
...
Cohesion: 0.09
Nodes (20): escapeAttr(), escapeHtml(), formatArtifactRendererError(), getArtifactRecoveryHint(), getArtifactTypeLabel(), ARTIFACT_LANGUAGE_ALIASES, balanced(), CODE_LANGS (+12 more)
...
Cohesion: 0.13
Nodes (17): ../lib/artifact-detector, ArtifactStatus, extractArtifactTitle(), generateArtifactId(), isArtifactUpdate(), simpleHash(), ArtifactQueue, Subscriber (+9 more)
...
Cohesion: 0.17
Nodes (10): ../lib/artifact-lifecycle, ../lib/artifact-queue, ../lib/markdown, ../lib/renderer-loader, regenerateArtifactEntry(), ArtifactEntry, createArtifactQueue(), createArtifactRegenerationPrompt() (+2 more)
...
- **Why does `setTimeout()` connect `Community 8` to `Community 0`, `Community 1`, `Community 6`, `Community 7`, `Community 16`, `Community 21`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `createRequestId()` connect `Community 0` to `Community 1`, `Community 11`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `kvKey()` connect `Community 0` to `Community 1`, `Community 12`, `Community 7`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
