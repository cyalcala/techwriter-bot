...
Cohesion: 0.07
Nodes (55): ALLOWED_ORIGINS, bindSession(), checkCSRF(), checkRateLimit(), dailyUsage, DC_ASNS, GET(), getReputation() (+47 more)
...
Cohesion: 0.09
Nodes (19): ../lib/artifact-types, ../lib/renderer-loader, a, blob, url, fail(), renderTimeout, chipBases (+11 more)
...
Cohesion: 0.11
Nodes (12): ../lib/artifact-lifecycle, ../lib/artifact-queue, ../lib/artifact-state, ../lib/cleanup, ../lib/markdown, ../lib/rag-client, ../lib/session-persist, ../lib/token-batcher (+4 more)
...
Cohesion: 0.24
Nodes (9): ../lib/stream-parser, ArtifactStatus, ArtifactEntry, ArtifactQueue, createArtifactQueue(), Subscriber, createArtifactRepairTarget(), planArtifactRepairReplacement() (+1 more)
...
Cohesion: 0.21
Nodes (8): extractArtifactTitle(), generateArtifactId(), isArtifactUpdate(), simpleHash(), ArtifactPlacement, ArtifactType, ParserState, trailingMarkerPrefixLength()
...
Cohesion: 0.2
Nodes (9): ../lib/artifact-detector, artifact, artifacts, base, parser, queue, result, taggedCases (+1 more)
...
- **Why does `kvKey()` connect `Community 0` to `Community 1`, `Community 3`?**
