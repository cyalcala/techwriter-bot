...
const ARTIFACT_COMPACT = [
  ...
  '',
  'Mermaid flowcharts must follow this EXACT pattern:',
  'graph LR',
  '  A[Step One] -->|does this| B[Step Two]',
  '  B -->|leads to| C[Step Three]',
  '  C -->|results in| D[Final Step]',
  'Use square brackets for nodes: A[Description]. Use pipes for edge labels: -->|action|. Use curly braces for decision diamonds: A{Choice}. Use subgraph for grouping. NO semicolons. NO "note" statements. NO "participant". Only graph syntax.',
  '',
