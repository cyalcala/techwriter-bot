export function getDiagramRenderDoc(type: string, code: string): string {
  ...
  const base = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=5,user-scalable=yes"><style>*{margin:0;padding:0;box-sizing:border-box}body{background:#faf7f2;padding:4px;font-family:system-ui,sans-serif;min-height:100dvh}.err{color:#b91c1c;background:#fef2f2;padding:16px;border-radius:10px;font-size:13px;margin:8px auto;text-align:center;max-width:400px}.err b{display:block;font-size:28px;margin-bottom:8px}.code-block{background:#f5f2ed;border:1px solid #e2ded5;border-radius:10px;padding:16px;font-size:12px;line-height:1.6;font-family:'JetBrains Mono','Fira Code',monospace;white-space:pre-wrap;word-break:break-word;max-width:100%;overflow-x:auto}svg{width:100%!important;height:auto!important;max-width:none!important;display:block}</style>`;
